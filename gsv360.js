...
window.onload = () => {
  alert(
    ...
    "EXIF の GPS 情報を読み取り、地図上にスナップを並べていく感覚で、旅の記録、フィールド調査、森林・環境モニタリング、文化財記録など、幅広い用途に活用できます。" +
    "GSV360にはデータ保存機能はありません。写真データの取り扱い・管理は、利用者自身の責任で行ってください。\n" +
    "- 本アプリは無保証で提供されます。- 動作の正確性、安定性、継続的な提供を保証するものではありません。- 本アプリの利用により発生したいかなる損害・トラブルについても、開発者は一切の責任を負いません。利用者は、これらの内容に同意した上で本アプリを利用するものとします。\n" +
